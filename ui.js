...
export function togglePassword() {
    ...
    const eye = document.getElementById('authTogglePwd');
...
export function switchAuthMode() {
    ...
    if (isRegisterMode) {
        ...
        subtitle.innerHTML = 'Join TaskForge today.<br><small style="opacity: 0.8; font-size: 12px;">Password: 8+ chars, 1 uppercase, 1 number, 1 special char</small>';
...
export async function handleAuthSubmit() {
    ...
    // Show spinner on button while the request is in flight
